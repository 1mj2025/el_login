...
import 'package:my_mini_app/src/widgets/barra_inferior.dart';
//import 'package:go_router/go_router.dart';
...
class _FavoritospageState extends State<Favoritospage> {
  ...
  final List<String> routes = ['/recetas', '/favoritos', '/login'];
...
//        context.go('/login');
    ...
    /*
    aqui estoy modificando para que me direcciones a login 
    hagamos un login*/
    setState(() {
      selectedIndex = index;
    });
